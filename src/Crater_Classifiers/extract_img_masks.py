...
if __name__ == "__main__":
    ...
    for gt_num in gt_list:
        ...
        cv.imwrite(gt_th_img_path, cv.cvtColor(th_img, cv.COLOR_BGR2GRAY))
        ...
        cv.imwrite(gt_mask_img_path, cv.cvtColor(gt_mask, cv.COLOR_BGR2GRAY))
        ...
        # save the mask image into masks folder
        cv.imwrite(gt_th_mask_img_path, cv.cvtColor(gt_th_mask, cv.COLOR_BGR2GRAY))
