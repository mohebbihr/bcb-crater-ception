...
import os
import pandas as pd
from helper import calculateDistance, BIRCH_duplicate_removal, Banderia_duplicate_removal, XMeans_duplicate_removal, draw_craters_rectangles, draw_craters_circles, evaluate_cmp
import Param

# the raw data to process for duplicate removal
param = Param.Param()
removal_method1 = 'Banderia'
removal_method2 = 'BIRCH'

csv_path = 'results/cnn/west_train_center_test_2_25_cnn.csv'
gt_csv_path = 'crater_data/gt/gt_tile2_25.csv'

path1 = 'results/cnn/evaluations/' + removal_method1 + '/west_train_center_test_2_25_cnn_noduplicates.csv'
path2 = 'results/cnn/evaluations/' + removal_method2 + '/west_train_center_test_2_25_cnn_noduplicates.csv'

save_path = 'results/cnn/evaluations/Banderia_BIRCH/west_train_center_test_2_25_cnn'
